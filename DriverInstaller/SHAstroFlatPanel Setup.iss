...
; Generated by Serhii Herniak on 2/12/2023 (UTC)
;
[Setup]
AppID={{3a1763d4-9140-11ee-b9d1-0242ac120002}
AppName=ASCOM SHAstroFlatPanel
AppVerName=ASCOM SHAstroFlatPanel Driver 1.1.0
AppVersion=1.0.0
...
OutputDir="."
OutputBaseFilename="SHAstroFlatPanel Setup"
Compression=lzma
...
UninstallFilesDir="{commoncf}\ASCOM\Uninstall\CoverCalibrator\SHAstroFlatPanel"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{commoncf}\ASCOM\Uninstall\CoverCalibrator\SHAstroFlatPanel"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "..\SHAstroFlatPanel\SHAstroFlatPanel\bin\Release\ASCOM.SHAstroFlatPanel.CoverCalibrator.dll"; DestDir: "{app}"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SHAstroFlatPanel.CoverCalibrator.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SHAstroFlatPanel.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SHAstroFlatPanel.CoverCalibrator.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SHAstroFlatPanel.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SHAstroFlatPanel.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
