...
//
// ASCOM CoverCalibrator driver for SHAstroFlatPanel
//
...
{
    //
    // Your driver's DeviceID is ASCOM.SHAstroFlatPanel.CoverCalibrator
    //
    // The Guid attribute sets the CLSID for ASCOM.SHAstroFlatPanel.CoverCalibrator
    // The ClassInterface/None attribute prevents an empty interface called
    // _SHAstroFlatPanel from being created and used as the [default] interface
    //
    ...
    /// ASCOM CoverCalibrator Driver for SHAstroFlatPanel.
    /// </summary>
    [Guid("b05e8271-f670-4bbd-bc2d-df44bb535653")]
    ...
    public class CoverCalibrator : ICoverCalibratorV1
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.SHAstroFlatPanel.CoverCalibrator";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SHAstroFlatPanel"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public CoverCalibrator()
        {
            tl = new TraceLogger("", "SHAstroFlatPanel");
